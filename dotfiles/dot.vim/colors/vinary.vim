...
if s:is_vinary_t "{{{2
  ...
  highlight IncSearch guifg=#0f2f1f guibg=#2fcf8f gui=bold,underline
                 \ ctermfg=22 ctermbg=79 cterm=bold,underline
  ...
  highlight WarningMsg guifg=#8f2f4f guibg=#ffafaf gui=underline
                  \ ctermfg=130 ctermbg=215 cterm=underline
  ...
  highlight LineNr guifg=#3fcfaf guibg=NONE gui=NONE
                  \ ctermfg=36 ctermbg=NONE cterm=NONE
  ...
  highlight StatusLineTermNC guifg=#565234 guibg=#c0afcf gui=bold
                  \ ctermfg=239 ctermbg=146 cterm=NONE
  ...
  highlight VisualNOS guifg=#ffffff guibg=#3f4f7f gui=bold,underline
                 \ ctermfg=15 ctermbg=111 cterm=bold,underline
  ...
  highlight DiffAdd guifg=fg guibg=#1f6f3f gui=NONE
                 \ ctermfg=NONE ctermbg=78 cterm=NONE
  ...
  highlight QuickFixLine guifg=#0f0f0f guibg=#cfafff gui=bold
                  \ ctermfg=52 ctermbg=218 cterm=bold
  ...
  highlight SpellBad guifg=#ff3f5f guibg=bg gui=undercurl
                 \ ctermfg=9 ctermbg=bg cterm=undercurl
  highlight SpellCap guifg=#3f4fff guibg=bg gui=undercurl
                 \ ctermfg=27 ctermbg=bg cterm=undercurl
  highlight SpellRare guifg=#3fff6f guibg=bg gui=undercurl
                 \ ctermfg=41 ctermbg=bg cterm=undercurl
  highlight SpellLocal guifg=#cfff3f guibg=bg gui=undercurl
  ...
  highlight PmenuSbar guifg=#cfcfcf guibg=#1f1f1f gui=NONE
                 \ ctermfg=255 ctermbg=236 cterm=NONE
  ...
  highlight TabLine guifg=#5f5f5f guibg=#efefff gui=NONE
                 \ ctermfg=241 ctermbg=189 cterm=NONE
  highlight TabLineFill guifg=#2f3f5f guibg=#efefff gui=bold
                 \ ctermfg=235 ctermbg=189 cterm=bold
  ...
  highlight NonText guifg=#af3faf guibg=bg gui=bold
                 \ ctermfg=163 ctermbg=bg cterm=bold
  highlight EndOfBuffer guifg=#6f79ff guibg=bg gui=bold
                 \ ctermfg=63 ctermbg=NONE cterm=bold
  ...
  highlight IncSearch guifg=#000000 guibg=#ffaf2f gui=bold
                 \ ctermfg=130 ctermbg=216 cterm=bold,underline
  highlight CurSearch guifg=#5f5f0f guibg=#efcf5f gui=bold,underline
                  \ ctermfg=136 ctermbg=222 cterm=bold,underline
  ...
  highlight StatusLineNC guifg=#6f6f6f guibg=#efdfcf gui=NONE
                 \ ctermfg=241 ctermbg=181 cterm=NONE
  highlight StatusLineTerm guifg=#afafaf guibg=#0f0f0f gui=NONE
                \ ctermfg=247 ctermbg=236 cterm=NONE
  highlight StatusLineTermNC guifg=#565234 guibg=#c0afcf gui=bold
  ...
  highlight VertSplit guifg=#6f6f6f guibg=#cfcfcf gui=bold
                 \ ctermfg=241 ctermbg=252 cterm=bold
  highlight WinSeparator guifg=NONE guibg=#efefff gui=bold
                  \ ctermfg=250 ctermbg=16 cterm=bold
  highlight FloatBorder guifg=NONE guibg=#cfcfcf gui=bold
                  \ ctermfg=250 ctermbg=16 cterm=bold
  highlight Title guifg=#af5f8f guibg=bg gui=underline
                 \ ctermfg=212 ctermbg=bg cterm=bold,underline
  ...
  highlight Visual guifg=#ffffff guibg=#1f2f5f gui=NONE
                 \ ctermfg=15 ctermbg=17 cterm=NONE
  highlight VisualNOS guifg=#ffffff guibg=#3f4f7f gui=bold,underline
                 \ ctermfg=253 ctermbg=17 cterm=bold,underline
  ...
  highlight FoldColumn guifg=#5f5faf guibg=#fff0fc gui=bold
                 \ ctermfg=56 ctermbg=225 cterm=bold
  ...
  highlight SignColumn guifg=fg guibg=#cfdfff gui=NONE
                 \ ctermfg=235 ctermbg=153 cterm=NONE
  ...
  " Popup: "{{{2
  highlight MessageWindow guifg=#2f2f2f guibg=#cfcfff gui=NONE
                  \ ctermfg=236 ctermbg=147 cterm=NONE
  highlight PopupNotification guifg=#2f2f2f guibg=#cfcfff gui=NONE
  ...
  highlight PmenuThumb guifg=#cfcfcf guibg=#4f0f2f gui=NONE
                 \ ctermfg=247 ctermbg=89 cterm=NONE
  ...
  highlight TabLineFill guifg=#5f5f5f guibg=#efefff gui=bold
                 \ ctermfg=240 ctermbg=255 cterm=bold
  highlight TabLineSel guifg=#cfcfcf guibg=#1f2f5f gui=NONE
  ...
  if has('multi_byte_ime') || has('xim')
    highlight CursorIM guifg=#000000 guibg=#af2f3f gui=NONE
                 \ ctermfg=231 ctermbg=124 cterm=NONE
  endif
  ...
  highlight CursorLineNr guifg=#af5f1f guibg=NONE gui=NONE
                 \ ctermfg=125 ctermbg=255 cterm=bold
  highlight CursorLineSign guifg=NONE guibg=#8faf8f gui=bold
                \ ctermfg=23 ctermbg=35 cterm=bold
  highlight CursorLineFold guifg=NONE guibg=#cfcfff gui=bold
...
if s:is_vinary_t "{{{2
  ...
  highlight Todo guifg=#3f3f3f guibg=#cfcfff gui=bold,underline
                 \ ctermfg=236 ctermbg=189 cterm=bold,underline
  ...
  highlight MatchParen guifg=#000000 guibg=#afffcf gui=bold
                 \ ctermfg=22 ctermbg=108 cterm=bold,underline
